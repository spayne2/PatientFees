// This file, patientAccount.cpp, holds the PatientAccount class 
// function definitions. Note that students may set a different 
...
const double DAILY_RATE = 3500.00;  // Cost per day in hospital
